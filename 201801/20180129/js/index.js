...
document.getElementById("tile-container").addEventListener("keydown", handleKeypress);
document.getElementById("tile-container").addEventListener('touchstart', handleTouchStart, false);
document.getElementById("tile-container").addEventListener('touchmove', handleTouchMove, false);

                ...
                if (!this.haslogin) {
                    ...
                    if (this.paytimes == 0) {
                        msgbox.showErrorMsg("主人，您没有砍价机会咯，开会员送2次机会，砍到1元即可1元抱走iPhone XS！", {
                            btn_title: "立即开通",
                            btn_href: "javascript:app.payBtnHandler(app.payId);;send_web_pv('click',{clickid:'acti_1yuan_xs2_1'});;"
                        })
                    } else {
                        msgbox.showErrorMsg("您没有砍价机会咯，继续砍价，砍到1元iPhone XS就是你的，更有50元红包+500元京东卡等你拿！", {
                            btn_title: "继续砍价",
                            btn_href: "javascript:app.payBtnHandler(app.payId);;send_web_pv('click',{clickid:'acti_1yuan_xs2_2'});;"
                        })
                    }
                } else {
                ...
                if (!this.haslogin) {
                    ...
                    if (1 == this.lotterytimes && 0 == this.paytimes) {
                        msgbox.showErrorMsg("送您的1次免费砍价机会，您还没用呢，快去砍价有机会1元拿走iPhone XS！", {
                            btn_title: "立即砍价",
                            btn_href: "javascript:;send_web_pv('click',{clickid:'acti_1yuan_xs3_1'});msgbox.exit()"
                        })
                    } else {
                        msgbox.showErrorMsg("砍到1元iPhone XS就是你的，开会员送2次砍价机会，超高机会赢iPhone XS，更有50元红包+500元京东卡等你拿！", {
                            btn_title: "立即开通",
                            btn_href: "javascript:app.payBtnHandler(app.payId);;send_web_pv('click',{clickid:'acti_1yuan_xs3_2'});"
                        })
                    }
                } else if (0 == this.prizeStatus[prize]) { //领取生活福利按钮逻辑
                    msgbox.showErrorMsg("您还没有开通哦，开通可免费领3大生活福利，快去开通吧", {
                        btn_title: "立即开通",
                        btn_href: "javascript:app.payBtnHandler(app.payId);;send_web_pv('click',{clickid:'acti_1yuan_xs4_1'});"
                    })

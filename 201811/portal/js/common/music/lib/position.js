define('js/common/music/lib/position.js', function(require, exports, module){
    ...
    var Position = {}, VIEWPORT = {
        _id: "VIEWPORT",
        nodeType: 1
    }, $ = require("js/common/music/jquery.js"), isPinFixed = false, ua = (window.navigator.userAgent || "").toLowerCase(), isIE6 = ua.indexOf("msie 6") !== -1;
    // 将目标元素相对于基准元素进行定位
    ...
    Position.center = function(pinElement, baseElement, r) {
        Position.pin({
            element: pinElement,
            x: (typeof(r)!='undefined'?r:50)+"%",
            y: (typeof(r)!='undefined'?r:50)+"%"
        }, {
            element: baseElement,
            x: (typeof(r)!='undefined'?r:50)+"%",
            y: (typeof(r)!='undefined'?r:50)+"%"

define('js/common/music/lib/attribute.js', function(require, exports, module){
    ...
    exports.set = function(key, val, options) {
        ...
        for (key in attrs) {
            ...
            if (!this.__initializingAttrs && (now[key]["forceChange"] || !isEqual(prev, val))) {
                if (silent) {
   ...
   */
    ...
    function isEmptyObject(o) {
        ...
        for (var p in o) {
            if (o.hasOwnProperty && o.hasOwnProperty(p)) return false;
        }
        return true;
    }

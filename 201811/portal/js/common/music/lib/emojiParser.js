define('js/common/music/lib/emojiParser.js', function(require, exports, module){

var ua = require('js/common/userAgent.js');
...
window.emojis = function(s) {
	s = s.replace(regexp, function(c) {
		...
		for (var i in valid)
		{
			if (!!valid[i].dict&&valid[i].dict.indexOf(c) != -1)
			{
				m.push(valid[i]);
			}
		}

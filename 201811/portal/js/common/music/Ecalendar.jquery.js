define('js/common/music/Ecalendar.jquery.js', function(require, exports, module){
...
$.fn.ECalendar = function (config) {
    ...
    _this.click(function (event) {
        ...
        if (height / 2 < top) {
            ECalendar.css({
                "left": offset.left + config.offset[0],
                "top": offset.top - config.offset[1] - ECalendar.height() - 1,
            });
        } else {
            ECalendar.css({
                "left": offset.left + config.offset[0],
                "top": offset.top + _this.outerHeight() + config.offset[1],
            });
        }
        _this.parent(".calendarWarp").css("zIndex", +10)
        ECalendar.show().css("z-index",config.zIndex);//这里增加了一个层级参数
    });

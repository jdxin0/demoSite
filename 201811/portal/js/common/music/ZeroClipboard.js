define('js/common/music/ZeroClipboard.js', function(require, exports, module){
 ...
 */
  var _getDefaultSwfPath = function() {
   // var jsDir = _getDirPathOfUrl(_getCurrentScriptUrl()) || _getUnanimousScriptParentDir() || "";
    return "//y.qq.com/portal/ZeroClipboard.swf";
  };
  /**
 ...
 */
  var _createEvent = function(event) {
    ...
    _extend(event, {
      ...
      timeStamp: event.timeStamp || new Date() || null
    });
 ...
 */
  var _preprocessEvent = function(event) {
    ...
    switch (event.type) {
     ...
     case "_mouseover":
		 if ($(element).hasClass('mod_btn'))
		 {
			$(element).addClass('mod_btn--hover');
		 }
		 if ($(element).hasClass('operate_menu__link'))
		 {
			$(element).addClass('operate_menu__link--hover');
		 }
     ...
     case "_mouseout":
		 if ($(element).hasClass('mod_btn--hover'))
		 {
			$(element).removeClass('mod_btn--hover');
		 }
		 if ($(element).hasClass('operate_menu__link--hover'))
		 {
			$(element).removeClass('operate_menu__link--hover');
		 }
      ZeroClipboard.blur();
      if (_globalConfig.bubbleEvents === true && sourceIsSwf) {
        if (element && element !== event.relatedTarget && !_containedBy(event.relatedTarget, element)) {
 ...
 */
  var _cacheBust = function(path, options) {
    ...
    if (cacheBust) {
      return (path.indexOf("?") === -1 ? "?" : "&") + "noCache=" + new Date();
    } else {
      return "";
    }
  };
